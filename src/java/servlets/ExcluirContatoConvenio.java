 ...
 * @author thiago
 */
@WebServlet(name = "ExcluirContatoConvenio", urlPatterns = {"/ExcluirContatoConvenio"})
public class ExcluirContatoConvenio extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            contato_convenioDAO.excluir(Integer.parseInt(request.getParameter("id_contato_convenio")));
