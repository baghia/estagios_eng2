 ...
 * @author thiago
 */
@WebServlet(name = "ExcluirSocioConvenio", urlPatterns = {"/ExcluirSocioConvenio"})
public class ExcluirSocioConvenio extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        try {
            SocioConvenio contato_convenio = new SocioConvenio();
