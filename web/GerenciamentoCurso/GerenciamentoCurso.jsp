...
<html>
    ...
    <body>
        <div class="container">
            <div>
                <h4 class="form-heading">Gerenciamento de Curso</h4>
            </div>
            <form class="form-horizontal" role="form" action="GerenciamentoCurso.jsp" method="get">
                <div class="form-group">
                    ...
                    <a class="btn btn-primary" href="CadastrarCurso.jsp"><span class="glyphicon glyphicon-plus"></span> Cadastrar Novo Curso</a>
                </div>
            </form>


            <table class="table table-striped table-bordered">
                <tr><th class="col-lg-3 h5 text-center"><b>Nome</b></th><th class="col-lg-3 h5 text-center"><b>Tipo</b></th><th class="col-lg-3 h5 text-center"><b>Turno</b></th><th class="col-lg-1 h5 text-center"><b>Editar</b></th><th class="col-lg-1 h5 text-center"><b>Desativar</b></th></tr>
                        <%
                ...
                <tr><td class="col-lg-3 h5 text-center"><%=  listCurso.get(i).getNome()%></td>
                    ...
                    <td class="col-lg-3 h5 text-center"><%= listCurso.get(i).getTurno()%></td>
                    <td class="col-lg-1 h5 text-center"><a class="btn btn btn-primary" href="EditarCurso.jsp?id=<%= listCurso.get(i).getId()%>"><span class="glyphicon glyphicon-pencil"></span> Editar</a></td>
